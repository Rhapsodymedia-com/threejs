...
class OutlineEffect {
	...
	constructor( renderer, parameters = {} ) {
		...
		const defaultSelectedObjects = parameters.defaultSelectedObjects !== undefined ? parameters.defaultSelectedObjects : [];
		...
		this.renderOutline = function ( scene, camera ) {
            ...
            defaultSelectedObjects.forEach(elem => setOutlineMaterial(elem))
			// scene.traverse( setOutlineMaterial );

			renderer.render( scene, camera );

			defaultSelectedObjects.forEach(ele => restoreOriginalMaterial(ele))
 ...
 * @property {Array<Object3D>} [defaultSelectedObjects=[]] - list of object to which apply outline effect.
